<div class="col-md-12">
    <div class="box">
        ...
        <div class="box-header with-border hide" id="filter-box">
            <form action="/admin/backup/tables_down_list" class="form-horizontal" pjax-container="" method="get">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control table_id" placeholder="tables_list接口的ID" name="table_id" value="{{$param['table_id']}}"></div>
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <table class="table table-hover" id="grid-table603c9c321cfbc">
                <thead>
                    <tr>
                        ...
                        <th class="column-nickname">表--标题</th>
                        <th class="column-nickname">备份类型</th>
                        <th class="column-nickname">备份逻辑</th>
                        <th class="column-nickname">数据表</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="column-nickname">{{$v['be_one_back']['nickname']}}</td>
                        <td class="column-back_id">{{$v['back_id']}}</td>
                        <td class="column-title">{{$v['be_one_table']['title']}}</td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <table class="table ">
                                                ...
                                                <tbody>
                                                    @foreach ($v['be_one_table']['inc_val'] as $v2)
                                                    <tr>
                                                        <td>{{$v2['table']}}</td>
                                                        <td>{{$v2['primarykey']}}</td>
    ...
    $(document).ready(function(){
        ...
        $('.all_down').stop().click(function(){
            ...
            if(id == ''){
                ...
                $.post("/admin/backup/down",{'_token':csrf_token,"id":id,"is_down":'true','model_down':'backup_tables'},function(res){
                    layer.open({
                      type: 1,
                      title: '下载进度页面',
                      shadeClose: true,
